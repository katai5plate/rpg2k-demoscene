...
## ピクチャのZ座標表現
- Z座標を10パターンで分割し、Z座標が100を超えると小さすぎて見えなくなるように調節する。
- たとえばZ座標が24の場合、20～30のため、拡大率は20または30で描画する。
### 画面中央を一点透視とする場合
- 縮尺を決め、それで割っていく。
- 参考：http://www.site-andoh.com/calc.html
...
- １フレームごとのログ出力
## 方法２：Unityを使う方法
- スクリーン座標に変換する過程が少し大変そう
- `StreamWriter` と `WriteLine` でログ出力
